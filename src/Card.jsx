  ...
  return (
    ...
    <div className="max-w-sm bg-teal-200 border border-teal-200 rounded-lg shadow dark:bg-teal-800 dark:border-gray-700 p-1">
        ...
        <div className="p-5">
          ...
          <a
            href={url}
            className="flex flex-col items-center  px-3 py-2 text-sm font-medium text-center text-white bg-teal-600 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Read more
          </a>
        </div>
